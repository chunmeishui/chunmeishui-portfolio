    ...
    <div className="main-container">
      <div className="basic-info" id="about-me">
        ...
        <p>
          ...
          have focused on HTML , CSS , JavaScript , Node.js ,
          git/Github,Storybook ,MYSQL , Postman and React to start with, and
          continue to study and work on private projects. I completed a bootcamp
          called Hack Your Future, and graduated in June 2022. I am also
